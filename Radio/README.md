# Experience - Radio mapping of the Milky Way using 21-cm line

## Introduction
This experience is focused on the analysis of the 21-cm emission line from hydrogen and its use to map the structure of the Milky Way using actual radio observations.
...
* **Tutorial 02** - [Tutorial on Object-oriented Python programming. An astronomical example](tutorials/tutorial02-classes-astropy.ipynb)
